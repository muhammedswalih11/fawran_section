                      ...
                      children: [
                        ...
                        CustomInputField(
                          ...
                          value: ref.watch(transferTypeProvider) != null
                              ? ref.watch(transferTypeProvider) == 'individual'
                                    ? 'Individual'
                                    : 'Corporate'
                              : '',
                          controller: ref.watch(transferTypeProvider) != null
                        ...
                        if (ref.watch(transferTypeProvider) != null) ...[
                          ...
                          if (ref.watch(beneficiaryAliasTypeProvider) == 0)
                            CustomInputField(
                          ...
                          if (ref.watch(beneficiaryAliasTypeProvider) == 1) ...[
                            CustomInputField(
                            ...
                            if (ref.watch(crProvider).verified) ...[
                              ...
                              CustomInputField(
                                ...
                                value:
                                    ref.watch(crProvider).beneficiaryName ?? '',
                                showDropdown: false,
                                isReadOnly: true,
                                isVerified: true,
                              ),
                              ...
                              CustomInputField(
                                label: 'Bank Name',
                                value: ref.watch(crProvider).bankName ?? '',
                                showDropdown: false,
                                isReadOnly: true,
                                isVerified: true,
                              ),
                              ...
                              SaveAliasWidget(
                                isChecked: isChecked,
                                onTap: () {
                                  ref.read(saveAliasProvider.notifier).state =
                                      !isChecked;
                                },
                              ),
                              SizedBox(height: screenHeight * 0.02),
                          ...
                          if (ref.watch(beneficiaryAliasTypeProvider) == 0 &&
                              ref.watch(selectedBeneficiaryAliasProvider) !=
                                  null) ...[
                            SizedBox(height: screenHeight * 0.02),
                            AmountFiled(controller: amountController),
                            SizedBox(height: screenHeight * 0.008),
                          ...
                          SizedBox(height: screenHeight * 0.02),
                          // Elevated Button - shows "Verify" for New (not verified), "Proceed" for New (verified) or Existing
                          ElevatedButton(
                            onPressed: () {
                              if (ref.read(beneficiaryAliasTypeProvider) == 1 &&
                                  !ref.read(crProvider).verified) {
                                // Verify action for New (not yet verified)
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  (ref.watch(beneficiaryAliasTypeProvider) ==
                                          1 &&
